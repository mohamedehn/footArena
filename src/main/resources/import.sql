...
-- Insert users
INSERT INTO users (id, first_name, last_name, email, password, enabled, role) VALUES (UUID_TO_BIN('49ecbc0f-d36d-4868-b4f0-ae67de5cd199'), 'Alice', 'Admin', 'alice.admin@footarena.com', '${bcrypt}$2a$10$rW3ZEBhU51gUj0rZClXvAuMu1jv4O6NGTgBMB57JSVFLRPzUtNCU6', true, 'ADMIN');
INSERT INTO users (id, first_name, last_name, email, password, enabled, role) VALUES (UUID_TO_BIN('e7759566-08d7-47fe-9886-3bb582f37ca6'), 'Bob', 'Manager', 'bob.manager@footarena.com', '${bcrypt}$2a$10$rW3ZEBhU51gUj0rZClXvAuMu1jv4O6NGTgBMB57JSVFLRPzUtNCU6', true, 'MANAGER');
INSERT INTO users (id, first_name, last_name, email, password, enabled, role) VALUES (UUID_TO_BIN('1e0fe7a2-0b94-4d72-bd4d-820bc54c3bb6'), 'Charlie', 'Player', 'charlie.player@footarena.com', '${bcrypt}$2a$10$rW3ZEBhU51gUj0rZClXvAuMu1jv4O6NGTgBMB57JSVFLRPzUtNCU6', true, 'PLAYER');
